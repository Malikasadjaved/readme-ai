...
vi.mock('../../src/providers/anthropic.js', () => ({
  createAnthropicProvider: vi.fn(() => ({ name: 'anthropic', model: 'claude', generate: vi.fn(), generateJSON: vi.fn() })),
}));

vi.mock('../../src/providers/openai.js', () => ({
  createOpenAIProvider: vi.fn(() => ({ name: 'openai', model: 'gpt-4o', generate: vi.fn(), generateJSON: vi.fn() })),
}));

vi.mock('../../src/providers/gemini.js', () => ({
  createGeminiProvider: vi.fn(() => ({ name: 'gemini', model: 'gemini-pro', generate: vi.fn(), generateJSON: vi.fn() })),
}));

vi.mock('../../src/providers/ollama.js', () => ({
  createOllamaProvider: vi.fn(() => ({ name: 'ollama', model: 'llama3', generate: vi.fn(), generateJSON: vi.fn() })),
}));
